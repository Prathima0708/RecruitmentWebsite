            ...
            <div className="col-md-12">
              ...
              <div className="featured-imagebox featured-imagebox-services style1">
                ...
                <div className="featured-content">
                  <div className="featured-title">
                    <h3>
                      <a href="/services_details">Manpower Supply</a>
                    </h3>
                  </div>
                  <div className="featured-desc">
                    <p>
                ...
                <div className="mb-md-40 mb-30">
                  <ul className="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor text-theme-DarkColor">
                    ...
                    <li>
                      <i className="far fa-check-circle"></i>
                      <div className="ttm-list-li-content">
                        We automatically complete profile with your professional
                        experience
                      </div>
                    </li>
                    <li>
                        ...
                        <TabPanel>
                          <div className="row">
                            ...
                            <div className="col-lg-8 col-md-9 col-sm-8">
                              <div className="pt-15">
                                <p>
                                  Let's enable the discovery of opportunities by
                                  providing consistently superior solutions. To
                                  add value & respect individuality and
                                  diversity while growing...
                                </p>
                                <ul className="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor text-theme-WhiteColor">
                                  <li>
                                    <i className="far fa-check-circle"></i>
                                    <div className="ttm-list-li-content">
                                      To add value for our clients & candidates
                                    </div>
                                  </li>
                                  <li>
                                    <i className="far fa-check-circle"></i>
