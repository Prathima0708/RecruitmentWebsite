        ...
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="job_list-widget">
                <aside className="widget job-widget">
                  ...
                  <ul>
                    ...
                    <li className="d-flex">
                      <b className="mr-5">Posted:</b>1 Week Ago
                    </li>
                    <li className="d-flex">
                      <b className="mr-5">Experience:</b>3 Years
                    </li>
                    <li className="d-flex">
                      <b className="mr-5">Industry:</b>Design
                    </li>
                    <li className="d-flex">
                      <b className="mr-5">Qualification:</b>Associate Degree
                    </li>
                    <li className="d-flex">
                      <b className="mr-5">position:</b>2
                    </li>
                  </ul>
                </aside>
                <aside className="widget form-widget">
                  <h3 className="widget-title">
                    <i className="ti ti-email"></i>Send Us Message
                  </h3>
                  ...
                  <div className="p-20">
                    ...
                    <div>
                      <a href="mailto:info@example.com">
                        <i className="fa fa-envelope mr-10"></i>info@example.com
                      </a>
                    </div>
                  </div>
                </aside>
            ...
            <div className="col-lg-8 content-area">
              ...
              <Slider
                className="row slick_slider slick-arrows-style2 mb_15"
                {...slick_slider}
                vertical={true}
                slidesToShow={1}
                rows={2}
